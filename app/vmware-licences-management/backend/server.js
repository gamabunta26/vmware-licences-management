...
app.get('/api/equipments', (req, res) => {
    const equipments = readJSONFile('data/equipments.json');
    res.json(equipments);
});

app.get('/api/licenses', (req, res) => {
    const licenses = readJSONFile('data/licenses.json');
    res.json(licenses);
});

app.get('/api/associations', (req, res) => {
    const associations = readJSONFile('data/associations.json');
...
app.post('/api/associations', (req, res) => {
    ...
    writeJSONFile('data/associations.json', associations);
